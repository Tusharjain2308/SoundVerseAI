...
export function DNABuilder() {
  ...
  return (
    <div className="flex h-screen text-white bg-[#0E0E0F]">
      ...
      <div className="flex-1 flex flex-col ">
        {/* Header */}
        {/* Header */}
        <div className="flex flex-col relative border-b border-neutral-800 bg-[rgba(42,31,31,0.12)] z-30 min-h-[200px] sm:min-h-[180px]">
          {/* Elliptical gradient */}
          <div className="absolute left-6 top-1/2 -translate-y-1/2 w-[300px] h-[150px] rounded-full bg-[rgba(102,171,255,1)] blur-3xl opacity-30 z-0" />
          ...
          {/* Step Buttons or placeholders (to maintain height) */}
          <div className="relative z-10 flex items-center flex-wrap gap-2 px-4 sm:px-6 py-3 min-h-[60px]">
            {hasStarted
        ...
        {/* Main Content */}
        <div className="flex-1 p-4 overflow-y-auto z-100">
          {hasStarted ? (
              ...
              <div className="bg-neutral-800/50 rounded-xl p-8 border border-neutral-700">
                ...
                <ul className="text-neutral-400 mb-8 space-y-2">
                  <li className="flex items-start gap-2 mb-0">
                    ...
                    <span>
                      <strong className="text-white">Build with AI:</strong>{" "}
                      With this, AI will take care of captions, categorisations,
                      tags.
                    </span>
                  </li>
