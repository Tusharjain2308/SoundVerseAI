...
export const DesktopSidebar = ({ className, children, ...props }) => {
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-[600px] px-3 py-4 hidden md:flex md:flex-col bg-black w-[300px] shrink-0 border-r border-neutral-800",
          className,
        )}
        animate={{
...
export const MobileSidebar = ({ className, children, ...props }) => {
  ...
  return (
    <>
      <div
        className={cn("h-10 px-4 py-4 flex flex-row md:hidden items-center justify-between bg-neutral-900 w-full")}
        {...props}
      >
...
export const SidebarLink = ({ link, className, isActive = false, ...props }) => {
